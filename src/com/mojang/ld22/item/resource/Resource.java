...
public class Resource {
	public static Resource wood_log = new Resource("Wood", 1 + 4 * 32, Color.get(-1, 101, 404, 545));
	public static Resource wood = new Resource("Plank", 1 + 4 * 32, Color.get(-1, 200, 531, 430));
	public static Resource wood_stick = new Resource("Wooden Stick", 1 + 4 * 32, Color.get(-1, 200, 531, 430));
	...
	public static Resource chacoal = new Resource("ChaCOAL", 10 + 4 * 32, Color.get(-3, 000, 111, 111));
