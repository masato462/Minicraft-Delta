...
public class Crafting {
	...
	static {
		try {
			//workbenchRecipes.add(new FurnitureRecipe(Torch.class).addCost(Resource.wood, 5).addCost(Resource.slime, 10).addCost(Resource.glass, 4));
			...
			workbenchRecipes.add(new ResourceRecipe(Resource.wood_stick).addCost(Resource.wood, 1));
			workbenchRecipes.add(new ResourceRecipe(Resource.wood).addCost(Resource.wood_log, 1));
			furnaceRecipes.add(new ResourceRecipe(Resource.chacoal).addCost(Resource.wood_log, 1));
